...
| 모듈 | 제목 | 예상 시간 | 상태 |
|------|------|----------|------|
| M1 | 설치 & 인증 & 핵심 개념 | 3-4시간 | ✅ 완료 (2026-03-29) |
| M2 | Brain & Session 명령어 마스터 | 4-5시간 | ✅ 완료 (2026-03-29) |
| M3 | Space & Thread 협업 기능 | 3-4시간 | ✅ 완료 (2026-03-29) |
| M4 | 실전 워크플로우 + 교과서 완성 (Capstone) | 2-3시간 | ✅ 완료 (2026-03-29) |
