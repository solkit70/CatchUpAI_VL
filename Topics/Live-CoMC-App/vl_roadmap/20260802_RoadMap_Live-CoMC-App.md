...
| M5 | 2026-08-20 | 2026-08-20 | ✅ | 100% (7/8, 1건 N/A) | 호출어 전사 0/11 → STT 이전 감지 필수 확인. CER 16.7%→8.6%(표기 허용). gpt-live-transcribe 는 Realtime 전용이라 사다리 교정. 3사 어댑터 동일 스키마 수렴. BGM 조건 N/A(헤드폰 셋업). 이월: LLM 지연 10.8~21.6초 원인 분석 |
| M6 | | | ⏳ | 0% | |
| M7 | | | ⏳ | 0% | |
| M8 | | | ⏳ | 0% | |
| M9 | | | ⏳ | 0% | |
