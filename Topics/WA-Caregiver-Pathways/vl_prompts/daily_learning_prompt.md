...
**Topic 이름**:
```
WA-Caregiver-Pathways
```

**Topic 폴더 경로**:
```
Ingest/CatchUpAI_VL/Topics/WA-Caregiver-Pathways/
```

**Roadmap 파일 경로**:
```
vl_roadmap/20260829_RoadMap_WA-Caregiver-Pathways.md
```
...
[상시 제약]
- 기관 문의(전화·이메일)는 사용자가 직접 수행한다. AI가 대리하지 않는다
- 볼트에 실제 신원 정보(SSN·면허번호·생년월일)를 기록하지 않는다
- 기관명·제도명은 1차 출처로 확인하기 전에는 사실로 쓰지 않는다
```
