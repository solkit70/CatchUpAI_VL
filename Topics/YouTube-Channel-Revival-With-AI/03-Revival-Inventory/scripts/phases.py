...
# 2026-09-15 갱신: daily/monthly_longform 을 9/13(API 마지막 확정일)까지 다시 받았다
END = "2026-09-13"
SIX_WEEKS_START = "2026-08-03"   # END 기준 42일

PHASES = [
    ("P1  DL 입문",       "2024-02-13", "2024-03-19"),
    ("P2  외부 기술 전달", "2024-03-20", "2025-03-31"),
    ("P3  라이브 방송",    "2025-04-01", "2026-02-23"),
    ("P4  AI 영상 제작",   "2026-02-24", END),
]
P4_SPLIT = [
    ("  P4a 라이브 요약",       "2026-02-24", "2026-07-10"),
    ("  P4b 단일 주제 (작전2)", "2026-07-11", END),
]
...
def main() -> None:
    ...
    segs = [("P3 라이브 방송 (기준선)", "2025-04-01", "2026-02-23"),
            ...
            ("발표 이후 (6/24 ~ 9/7)", "2026-06-24", END),
            ("🔥 최근 6주 (7/28 ~ 9/7)", SIX_WEEKS_START, END)]
    vals = {}
    for lab, s, e in segs:
        m = months_between(s, e)
...
def retention() -> None:
    ...
    SEG = [("P4a 라이브 요약  (4/03~7/10)", "2026-04-01", "2026-07-10"),
           ("P4b 단일 초기    (7/19~8/13)", "2026-07-19", "2026-08-13"),
