...
|---|---|---:|---:|---:|---|
| P2 외부 기술 전달 | 24/03 ~ 25/03 | 12.4 | 5,751 | **+231** | 핵심 성장기 |
| P3 라이브 방송 | 25/04 ~ 26/02 | 10.8 | 4,730 | +125 | 전환 후 하락 |
| P4 AI 영상 제작 | 26/02 ~ 26/06 | 3.9 | 2,398 | **+18** | *"진행 중"* |
| **→ 최근 6주** | **26/07 ~ 26/09** | 1.4 | **4,320** | **+19** | 오늘 |
