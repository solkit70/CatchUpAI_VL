...
- [x] 2026-08-02 NGO·비영리·시민단체 실무자 신청 옵션 추가
- [x] 2026-08-02 Preview 테스트 정상 진행 확인

**테스트 완료일**: 2026-07-21 — 모든 분기·필수 입력·Sheets 연동 정상 확인.
**업데이트 테스트 완료일**: 2026-08-02 — 신청 목적 문항 추가, NGO 실무자 설명 확장, 기존 국가 분기 정상 확인.

## 참고

- Form 구조: Section 1(성함·이메일·신청 목적·나라) → 🇺🇸 미국이면 Section 2(워싱턴주 거주 여부) → Section 3(앱/업무 도구/문서 정리/행사·프로젝트 지원 시스템 설명)
