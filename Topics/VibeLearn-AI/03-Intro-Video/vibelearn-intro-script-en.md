# VibeLearn AI: A New Way to Learn Systematically with AI

> **Video Info**
> - Language: English
> - Target length: 15-18 minutes
> - Audience: People who want to learn something with AI but need a systematic approach
> - Purpose: Introduce VibeLearn AI methodology + demo + case study
...
### Slide 4: The Learning Loop That Never Ends
...
### Slide 5: New Problems When Learning With AI
...
### Slide 6: What If We Could Solve All Four at Once?
...
## Section 3: What Is VibeLearn AI

---

### Slide 7: VibeLearn AI in One Line
...
### Slide 8: What the Name Means

## 💬 Breaking Down "VibeLearn AI"

- **Vibe**: Natural, intuitive collaboration with AI
  - Inspired by "Vibe Coding" — building things intuitively with AI
- **Learn**: Structured learning, organized knowledge
- **AI**: AI as the core partner

**= Learning systematically through natural AI collaboration**

The name itself captures the philosophy. "Vibe" comes from Vibe Coding — that intuitive, natural way of working alongside AI to create things. "Learn" adds the structure and intentionality of systematic knowledge-building. Put them together: learning systematically through natural collaboration with AI.

---

### Slide 9: The Core Design Principle
...
### Slide 11: Works for Any Subject
...
### Slide 12: What You Need to Get Started
...
> 💡 Web-based AI (ChatGPT web, Claude.ai) can't create files directly — they're inefficient for this.
> Use an editor-integrated AI tool for the best experience.

The setup is minimal. An AI tool and something to learn — that's all. The key is using an AI tool that can access your file system, so it can actually create folders, read files, and write WorkLogs. Editor-integrated tools like VS Code with Copilot or Cursor work great. Web-based AI won't work as smoothly since they can't directly create files.

---

### Slide 13: Step 1 — Get the Repository
...
### Slide 14: Step 2 — Open in Your AI Tool

## 💻 Step 2: Open the Folder in Your AI Tool (2 minutes)
...
### Slide 15: Step 3 — Just Say What You Want to Learn
...
### Slide 16: Real Case — Learning the Clearly App
...
### Slide 18: What If There Was No VibeLearn AI?
...
### Slide 19: The Actual Output Structure
...
### Slide 21: As You Get More Comfortable
