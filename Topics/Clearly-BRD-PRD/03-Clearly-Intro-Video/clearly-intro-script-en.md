# Complete Guide to Clearly App: Write BRD/PRD with AI and Start Vibe Coding

> **Video Info**
> - Language: English
> - Target Length: 15+ minutes
> - Audience: Developers and non-developers interested in AI tools, people ready to start Vibe Coding
> - Purpose: Introduce Clearly app + step-by-step tutorial + real homepage project demo
...
## Section 2: Vibe Coding and the Problem
...
### Slide 6: The Core Problem with Vibe Coding
...
### Slide 8: The Evolving Role of Developers
...
## Section 3: Introducing the Clearly App

---

### Slide 9: Clearly App — Key Features
...
3. 🔧 **Output Tool** — Optimized files generated for your dev tool (Claude Code, Cursor, v0, etc.)
...
### Slide 10: BRD vs PRD — Key Differences
...
### Slide 12: Clearly = The Starting Point for Vibe Coding
...
What impressed me most about Clearly was that it's not just a document tool. After the Output Tool step, configuration files are automatically generated that you can use directly in AI coding tools like Claude Code or Cursor. So the flow is: start with an idea → create BRD/PRD with Clearly → auto-generate dev tool configuration with Output Tool → immediately start coding with an AI coding tool. That's the complete Vibe Coding workflow.

---

## Section 4: Step-by-Step Tutorial Demo

---

### Slide 13: Getting Started — Create a Project
...
- **Project Title**: Your project name (e.g., "Catch Up AI 2026 Homepage")
...
Now, the BRD Wizard. As you can see on screen, AI presents questions one by one. Below each question are 3 sample answers — use these as reference and respond according to your project. An important thing to note about the "Generate BRD" button activation: it's not a fixed number of questions. When Clearly judges it has collected enough information to write a BRD, the button activates. It can activate after just 2-3 answers. If you want a richer document, keep answering. About 5 questions are presented in total.

---

### Slide 15: BRD Wizard — Answer Tips
...
- Research your URLs, target users, KPIs beforehand
...
### Slide 15-B: Pro Tip — Prepare Answers with AI
...
**⚠️ Important**: Save locally immediately after generating! (don't risk server data loss)
...
- Takes the "Why/What" of the BRD and makes the "How" concrete
- More technical questions than the BRD
...
### Slide 18: Output Tool — Claude Code Integration
...
- `.claude/settings.json` — project metadata/tech stack
- `PRD.md` — PRD in Output Tool format
...
### Slide 19: Practical Tips & Best Practices
...
- ✅ Use sample answer structures but customize content for your project
- ✅ Always review the BRD before moving to PRD

**How to use efficiently:**
- 💡 More detail in Initial Idea → better BRD quality
- 💡 Pre-discuss with AI tools → better Wizard answer quality
- 💡 Even after Generate BRD activates, keep answering for richer output
- 💡 Markdown export makes editing and reuse much easier

A few more practical tips. The most important one is saving locally. Export to Markdown at the end of each stage and save locally. And if you organize what you want to answer in a text file beforehand, or have a thorough conversation with AI tools about your project, the process goes much faster. For efficient usage: the more detailed your Initial Idea, the more relevant questions AI generates. And reviewing and carefully approving the BRD is key to getting higher quality PRD output.

---

## Section 5: Real Results Demo

---

### Slide 20: My Project — Catch Up AI Homepage
...
**Key features:**
- 5 project pages (Vibe Coding, Vibe Learning, etc.)
...
### Slide 22: PRD → Claude Code Integration
...
### Slide 23: The Finished Homepage
...
## Section 6: Key Insights & Outro

---

### Slide 24: Key Insights Summary
...
> **Metadata**
> - Total slides: 27
> - Estimated video length: approx. 15–18 minutes
> - Created: 2026-02-24
> - Reference documents:
