...
- [ ] SSH, Tailscale/ZeroTier, 클라우드 개발 환경, 홈서버, 노트북 클라이언트 구조를 비교표로 평가할 수 있다.
...
| M4 | 모바일 원격 실행 1차 실험 설계 및 수행 | 3 | 2.5h | `04-Remote-Execution-Lab/` | 대기 |
| M5 | 보안, 운영, 백업 가이드 정리 | 2 | 1.5h | `05-Operations-Security/` | 대기 |
| M6 | 최종 패키징과 Remotion AI 영상화 후보 정리 | 2 | 1h | `06-Publishing-Video-Plan/` | 대기 |
...
- [ ] 6개 모듈의 DoD 100% 달성
- [ ] 모바일 조작과 로컬 실행 구조 설명 문서 완성
- [ ] 기술 구조 비교표와 홈서버 도입 판단표 완성
- [ ] 현재 Windows 노트북 기준 1차 원격 실행 실험 완료
- [ ] 보안/운영/백업 런북 완성
- [ ] Remotion AI 영상화 후보 문서 완성
