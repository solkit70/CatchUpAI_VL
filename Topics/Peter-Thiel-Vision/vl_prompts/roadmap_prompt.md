...
**Topic 설명**:
```
피터 틸의 세계관, 기업·투자·정치적 영향력, 그리고 그 비전의 타당성과 위험을 VibeLearn AI 방식으로 학습한다. 최종 목표는 "피터 틸이 바라는 세상은 과연 옳은가?"라는 질문에 답할 수 있는 에세이용 리서치 기반을 만드는 것이다.
```
...
**vl_materials/ 폴더**:
```
- local-source-map.md: Vault 내부 관련 자료 맵
- web-source-map.md: 웹 리서치 대상과 우선순위
- source-bibliography.md: 출처별 신뢰도와 활용 목적
- quote-bank.md: 원문 인용과 해석 모음
```
