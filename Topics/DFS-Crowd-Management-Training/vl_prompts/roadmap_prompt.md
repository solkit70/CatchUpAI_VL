...
**예상 학습 기간**: `2주 (총 12-16시간, 스크린샷 반영 시간 별도)`
...
**참조 자료**:
```
- BigHug Crowd Manager Training 원문
- Crowd Manager Training Share Guide
...
**vl_materials/ 폴더**:
```
원자료의 복사본, 추후 제공될 DFS 교육·테스트 스크린샷, 공식 출처 검증 기록을 보관한다.
```
