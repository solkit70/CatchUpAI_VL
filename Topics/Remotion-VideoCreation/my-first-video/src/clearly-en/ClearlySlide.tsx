...
export const ClearlySlide: React.FC<ClearlySlideProps> = ({
  ...
  const slideImageSrc = staticFile(`clearly-en/slides/${slide.slideNum}.jpeg`);
  const audioSrc = staticFile(`clearly-en/audio/slide_${slide.audioIndex}.mp3`);
  const screenshotSrc = slide.screenshot
    ? staticFile(`clearly-en/screenshots/${slide.screenshot}`)
    : null;
