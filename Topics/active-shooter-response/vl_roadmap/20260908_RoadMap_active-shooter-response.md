...
| **M2** | NGO 공인 대응 트레이닝 수강 경로 및 에셋 기획 | ⭐⭐ | 3.0h | `02-Remotion-Setup/` | 🔄 **재기획 중** |
| **M3** | 모션 애니메이션 컴포넌트 및 배경 개발 | ⭐⭐⭐ | 4.0h | `03-Remotion-Development/` | ⏳ 대기 |
...
| **M2** | 2026-09-13 | | 🔄 진행 중 | 0% | NGO 트레이닝 및 자원 경로 가이드로 전면 재기획 착수 |
| **M3** | | | ⏳ 대기 | 0% | |
| **M4** | | | ⏳ 대기 | 0% | |
| **M5** | | | ⏳ 대기 | 0% | |
