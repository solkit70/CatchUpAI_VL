---
title: "노조 local을 통한 진입 절차"
created: 2026-08-28 21:40:00
tags:
...
```mermaid
flowchart TB
    A["1. 해당 지역 프로그램 찾기<br/>L&I 견습 프로그램 공개 검색"] --> B["2. 프로그램 표준서 확인<br/>WSATC 표준서 PDF"]
    B --> C["3. 지원<br/>Apprenticeship Coordinator 에게 직접"]
    C --> D["4. 선발<br/>시험 · 면접"]
    D --> E["5. 등록<br/>L&I 견습생 등록"]
    E --> F["6. 유급 훈련 시작<br/>현장 + 강의 병행"]
```
