...
```mermaid
flowchart TB
    subgraph P["돈이 안 드는 것부터"]
        direction LR
        A["Cisco Packet Tracer<br/>Networking Academy 입문<br/>무료"] --> B["Microsoft Learn<br/>Linux VM 실습<br/>무료"]
        B --> C["CompTIA A+ 응시<br/>$548 · 집에서"]
        C --> D["Network+ 응시<br/>$399 · 집에서"]
    end
```
